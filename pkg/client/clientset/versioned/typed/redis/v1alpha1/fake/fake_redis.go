...
var redisesResource = schema.GroupVersionResource{Group: "redis.database.samsung.com", Version: "v1alpha1", Resource: "redises"}

var redisesKind = schema.GroupVersionKind{Group: "redis.database.samsung.com", Version: "v1alpha1", Kind: "Redis"}
