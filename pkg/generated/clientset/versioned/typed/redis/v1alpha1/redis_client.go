...
import (
	v1alpha1 "gitlab.com/mvenezia/redis-operator/api/redis/v1alpha1"
	"gitlab.com/mvenezia/redis-operator/pkg/generated/clientset/versioned/scheme"
...
// RedisV1alpha1Client is used to interact with features provided by the redis group.
