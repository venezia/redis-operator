...
packages() {
  echo "./cmd/redis-operator ./pkg/apis/redis/v1alpha1 ./pkg/client/clientset/versioned ./pkg/client/informers/externalversions ./pkg/controller ./pkg/redis ./pkg/util"
}
